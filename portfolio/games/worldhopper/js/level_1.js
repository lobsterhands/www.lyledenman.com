  ...
  create: function() { 
    ...
    if (playerHigh) {
      ...
      if (playerRight) {
        ...
        this.player.body.drag.setTo(0, this.DRAG/2);    
      } else if (playerLeft) {
        this.player.body.gravity.x = this.GRAVITY;
        this.player.body.drag.setTo(0, this.DRAG/2);
      } else {
    ...
    if (rightInputIsActive() && !playerLow) {
      this.player.body.acceleration.x = this.ACCELERATION;
    } else if (rightInputIsActive() && playerLow) {
      this.player.body.acceleration.x = -this.ACCELERATION;
    } else  if (leftInputIsActive() && !playerLow) {
      this.player.body.acceleration.x = -this.ACCELERATION;
    } else if (leftInputIsActive() && playerLow) {
      this.player.body.acceleration.x = this.ACCELERATION;
    } else {
